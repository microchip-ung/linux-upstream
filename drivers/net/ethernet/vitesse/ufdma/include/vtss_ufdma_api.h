...
typedef struct {
     ...
     * (through a call to vtss_ufdma_platform_driver_t::uninit()), it will contain
     ...
     *
     * If the network driver provided a timestamp function in the call
...
typedef struct vtss_ufdma_platform_driver_s {
     ...
     * to convert to a textual representation.
     */
    int (*poll)(struct vtss_ufdma_platform_driver_s *self);
     ...
     * to convert to a textual representation.
     */
    int (*rx_poll)(struct vtss_ufdma_platform_driver_s *self);
